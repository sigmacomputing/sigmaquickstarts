...
This was formally named: build_customer_facing_applications_using_sigma_and_snowflake but was replaced
for an updated version and matched copy on Snowflake's QS site. Left old name in place to avoid link changes.
-->
