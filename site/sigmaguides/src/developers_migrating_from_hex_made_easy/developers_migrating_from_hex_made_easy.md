...
Nothing about this folder is Hex-specific — reuse the same one for every migration QuickStart you run.
...
<img src="assets/mfhx_10.png" width="800"/>
...
**Step 1: Download the sample Hex project file.**<br>
This is the exported `Commerce Dashboard.yaml` referenced in the Overview — the skill reads it directly, no Hex account needed.

```copy-code
curl -o ~/sigma-migration-workspace/"Commerce Dashboard.yaml" "https://sigma-quickstarts-main.s3.us-west-1.amazonaws.com/yaml-files/Commerce+Dashboard.yaml"
```

**Step 2: Load the warehouse side.**<br>
...
Hex
- Project file: ~/sigma-migration-workspace/Commerce Dashboard.yaml
