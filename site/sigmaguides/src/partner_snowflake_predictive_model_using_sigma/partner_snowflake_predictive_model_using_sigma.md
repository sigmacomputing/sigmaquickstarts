...
Build a Snowflake ML price prediction model and surface results in Sigma — a complete example covering both the data science setup and the business analyst workflow. Our focus will be on creating a machine learning-driven price prediction tool, integrating the perspectives of both a business analyst and a data scientist using Snowflake and Sigma.
...
<strong>NOTE:</strong><br> If you are coming to this quickstart to learn how to build a model on top of a data asset you have already created, you can skip to step 5.
</aside>

### Prerequisites

The following notebook has been provided for you to load into your Snowflake interface.
...
<img src="assets/ml4.png" width="600"/>

4: Add a new table, and then select Upload CSV as an option ml3.png 
