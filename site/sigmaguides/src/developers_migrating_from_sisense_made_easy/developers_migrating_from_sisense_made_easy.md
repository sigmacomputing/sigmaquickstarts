...
summary: Use the sisense-to-sigma Claude Code skill to convert a Sisense dashboard into a Sigma data model and workbook, then verify results with a parity check against the warehouse.
